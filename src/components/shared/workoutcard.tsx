...
const WorkoutCard = ({ workout }: WorkoutCardProps) => {
    ...
    return (
        <div className="card w-96 overflow-hidden rounded-3xl border border-neutral-800 bg-neutral-950">
            <figure>
                <Image
                    src={image}
                    width={500}
            ...
            <div className="card-body">
                ...
                <h2 className="card-title text-2xl font-extrabold uppercase tracking-tight text-white">
                    {name}
                </h2>
